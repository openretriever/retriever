...
"""Tests for IR OO methods (Core only, no Viz)."""

import sys
from unittest.mock import MagicMock

# MOCK DASH to avoid Environment ImportError
sys.modules["dash"] = MagicMock()
sys.modules["dash_cytoscape"] = MagicMock()
sys.modules["flask"] = MagicMock()
sys.modules["werkzeug"] = MagicMock()
sys.modules["werkzeug.urls"] = MagicMock()
...
class TestIRCoreRefactor:
    """Test IR OO methods (Core only)."""
