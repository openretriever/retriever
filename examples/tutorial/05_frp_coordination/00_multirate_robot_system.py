...
Run (multiprocessing):
  pixi run python -m examples.tutorial.05_frp_coordination.00_multirate_robot_system --backend multiprocessing --duration 5
...
from retriever.core.flow import Flow, Pipeline, Rate, flow_io
