...
Pendulum (requires `gymnasium` or `gym`):
  pixi run python -m examples.tutorial.d_closed_loop_state_feedback.01_closed_loop_env --env pendulum --backend multiprocessing --hz 20 --duration 5
...
Rate lag demo (Dora, intentionally force lag):
  ...
  pixi run python -m examples.tutorial.d_closed_loop_state_feedback.01_closed_loop_env --env pendulum --backend dora --hz 50 --duration 5 --on-lag warn
"""
