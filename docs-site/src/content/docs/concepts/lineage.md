---
title: Concepts and Lineage
description: How Retriever concepts map to FRP, synchronous dataflow, and the systems that inspired them — with references.
---
...
If you are new, read [Flow](/concepts/flow/) and the
[Time and Sync](/concepts/time-and-sync/) first; this page is the "where does this
come from" companion.
