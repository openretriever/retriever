...
<div class="card-grid">
  ...
  <a class="info-card" href="https://retriever-space.pages.dev/"><strong>Continue to Golden</strong><span>Move from the core visual demo to maintained robot-facing examples and Hub-pack proof.</span></a>
</div>
