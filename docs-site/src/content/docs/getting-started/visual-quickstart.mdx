...
<div class="card-grid">
  ...
  <a class="info-card" href="https://golden.retriever.build/examples/golden-hub-proof/"><strong>Run the first GoldenRetriever proof</strong><span>Move from the core demo to a maintained Hub-loaded robot payload.</span></a>
</div>
