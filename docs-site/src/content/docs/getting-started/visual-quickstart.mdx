...
This is a source-checkout demo target. The runtime-only distribution is `retriever-core`, but examples, Rerun, graph rendering, and tutorial assets live in the repository environment.
