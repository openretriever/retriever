...
This is a source-checkout demo target. The PyPI distribution target is `retriever-core`, while examples, Rerun, graph rendering, and tutorial assets live in the repository environment once public code visibility is enabled.
