...
<div class="card-grid">
  ...
  <a class="info-card" href="https://retriever-space.pages.dev/examples/golden-hub-proof/"><strong>Run the first Golden proof</strong><span>Move from the core demo to a maintained Hub-loaded robot payload.</span></a>
</div>
