...
@_register_data_contract("EventRef", tags=("data", "v1", "lineage"))
...
@_register_data_contract("LineageRef", tags=("data", "v1", "lineage"))
@dataclass(frozen=True)
class LineageRef:
...
@_register_data_contract("Event", tags=("data", "v1", "event"))
@dataclass(frozen=True)
...
@_register_data_contract("EventBuffer", tags=("data", "v1", "event", "buffer"))
@dataclass(frozen=True)
...
@_register_data_contract("MultiStreamBuffer", tags=("data", "v1", "event", "buffer"))
@dataclass(frozen=True)
...
@_register_data_contract("JoinPolicy", kind="policy", tags=("data", "v1", "policy", "join"))
@dataclass(frozen=True)
class JoinPolicy:
...
@_register_data_contract("WatermarkPolicy", kind="policy", tags=("data", "v1", "policy", "watermark"))
@dataclass(frozen=True)
...
@_register_data_contract("WindowPolicy", kind="policy", tags=("data", "v1", "policy", "window"))
@dataclass(frozen=True)
class WindowPolicy:
...
@_register_data_contract("FieldSpec", kind="spec", tags=("data", "v1", "spec", "field"))
@dataclass(frozen=True)
class FieldSpec:
    name: str
    type_name: str
