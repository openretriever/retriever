...
Use: `examples/00_refact/011_debug_stepper.py`

What to do:

1. Open `examples/00_refact/011_debug_stepper.py`
...
```sh
python -m examples.00_refact.011_debug_stepper --fail-at 3
```
...
- `examples/00_refact/012_debug_perception_stepper.py`
...
- `examples/00_refact/014_record_replay_perception.py`:
  - Record: `python -m examples.00_refact.014_record_replay_perception record ...`
  - Replay: `python -m examples.00_refact.014_record_replay_perception replay ...`
